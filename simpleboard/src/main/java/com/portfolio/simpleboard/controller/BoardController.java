...
public class BoardController {
    ...
    @PreAuthorize("hasRole('ADMIN') or hasAuthority('BOARD_READ')")
    @GetMapping("")
    ...
    @PreAuthorize("hasRole('ADMIN') or hasAuthority('BOARD_CREATE')")
    @GetMapping("/insert")
    ...
    @PreAuthorize("hasRole('ADMIN') or hasAuthority('BOARD_DELETE')")
    @DeleteMapping("/{id}")
